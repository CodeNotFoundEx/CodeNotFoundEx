...
2. **PROS/CONS of Keeping All Spring Boot Projects in the Same Folder**
    ...
    - CONS:
        ...
        2. **AI Context**: AI context can get overflown when you have multiple microservices that do not have a clear
           boundaries.
      > **Christian Tzolov**: "Agents are only as useful as what they remember — conversation history alone isn't
      enough. When the window fills, important facts get
      evicted." [Blog Link](https://spring.io/blog/2026/04/07/spring-ai-agentic-patterns-6-memory-tools)
3. In order to forward the Login process of the Oauth2 Authorization Server
 we need to include OAuth2 login flow, which is necessary to obtain tokens before TokenRelay can pass
